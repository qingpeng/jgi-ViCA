...
parser.add_argument('-t','--training', help='a training pickle', required=True)
parser.add_argument('-d,','--data',help= 'a data pickle', required=True)
...
with open(training, 'rb') as pk:
	modtrain = pickle.load(pk)
	classtrain = pickle.load(pk)
print("classes and elements in class vector:")
print(Counter(classtrain))
modt = np.array(modtrain)


#load objects classvect, modvect
with open(data, 'rb') as pk:
	moddata = pickle.load(pk)
	classdata = pickle.load(pk)
print("classes and elements in class vector:")
print(Counter(classdata))
modd = np.array(moddata)
...
verify_array(modt, clstrain_viral)
...
moddscaled = scaler.transform(modd)
##validate data
