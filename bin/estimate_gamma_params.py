...
parser.add_argument('--fitplot', help ="a file with more information on the fit", default="gammafit.pdf") 
...
fit_alpha, fit_loc, fit_scale=scipy.stats.gamma.fit(npcnt)

#output the parameters
args.output.write("alpha"+"\t"+"loc"+"\t"+"fit_scale"+"\n")
args.output.write(str(fit_alpha)+"\t"+str(fit_loc)+"\t"+str(fit_scale)+"\n")
