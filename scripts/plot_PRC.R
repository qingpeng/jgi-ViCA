...
ggplot() + 
       geom_point(aes(V1, V2, colour = 'with Pfam,auPRC:0.9761'), data = PRC_withPfam_run2) + 
       geom_point(aes(V1, V2, colour = 'No Pfam'), data = PRC_withoutPfam) + 
       geom_point(aes(V1, V2, colour = 'Pfam Only, auPRC:0.9691'), data = PRC_PfamOnly) +
       geom_point(aes(V1, V2, colour = 'with Pfam + Vfam, auPRC:0.9775'), data = PRC_PfamVfam) +
