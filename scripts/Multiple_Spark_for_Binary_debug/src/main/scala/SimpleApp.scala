...
object Simple {
    ...
    def main(args: Array[String]) {
        ...
        val training_5k = MLUtils.loadLibSVMFile(sc,"/global/projectb/scratch/qpzhang/Full_Training/Pfam/Vfam_run/training2.svmlib")
        val test_5k = MLUtils.loadLibSVMFile(sc, "/global/projectb/scratch/qpzhang/Full_Training/Pfam/Vfam_run/testing2.svmlib")
        training_5k.cache()
