...
//        val training_5k = MLUtils.loadLibSVMFile(sc,"/global/projectb/scratch/qpzhang/Full_Training/Pfam/Vfam_run/training.vect.svmlib")
        val training_5k = MLUtils.loadLibSVMFile(sc,"/global/projectb/scratch/qpzhang/Run_Genelearn/Full_nextflow/all_segment.fasta.vect.family.training.svmlib")
//        val test_5k = MLUtils.loadLibSVMFile(sc, "/global/projectb/scratch/qpzhang/Full_Training/Pfam/Vfam_run/testing.vect.svmlib")
        val test_5k = MLUtils.loadLibSVMFile(sc, "/global/projectb/scratch/qpzhang/Run_Genelearn/Full_nextflow/all_segment.fasta.vect.family.testing.svmlib")
        training_5k.cache()
