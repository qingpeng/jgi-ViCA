 ...
 #   print tax_dict
    ...
    # must have all 4 tax id in 4 levels
        ...
        # if the family of this  record is picked as testing for the order it belongs to
            ...
            file_order_testing_obj.write(fields[0] + str(order_id_num)+' '+to_svmlib(vectors_line, feature_list)+'\n')
            ...
            if order_testing[tax_dict["11"]] != []: # only if there are >=2 sub nodes
                ...
                file_order_training_obj.write(fields[0] + str(order_id_num)+' '+to_svmlib(vectors_line, feature_list)+'\n')
        ...
        if tax_dict["20"] in family_testing[tax_dict["16"]]:
            ...
            file_family_testing_obj.write(fields[0] + str(family_id_num)+' '+to_svmlib(vectors_line, feature_list)+'\n')
        else:
            if family_testing[tax_dict["16"]] != []:
                ...
                file_family_training_obj.write(fields[0] + str(family_id_num)+' '+to_svmlib(vectors_line, feature_list)+'\n')
        ...
        if tax_dict["24"] in genus_testing[tax_dict["20"]]:
            ...
            file_genus_testing_obj.write(fields[0] + str(genus_id_num)+' '+to_svmlib(vectors_line, feature_list)+'\n')
        else:
            if genus_testing[tax_dict["20"]] != []:
                ...
                file_genus_training_obj.write(fields[0] + str(genus_id_num)+' '+to_svmlib(vectors_line, feature_list)+'\n')
