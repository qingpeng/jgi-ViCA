...
class AlignmentFile:
    ...
    def check_line(self, line, tax_level):
        ...
        # print "test", taxid_query, taxid_target
            ...
            return True  # if can't find taxid for target, keep this record.
        ...
        if self.test_same_rank(taxid_query, taxid_target, tax_level):
            ...
            return True  # not in the same, keep this record
