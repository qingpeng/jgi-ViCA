...
class AlignmentFile:
    ...
    @staticmethod
    def test_same_rank(tax_id_1, tax_id_2, rank_level, filter_option):
    ...
    def filtering(self, filter_option):
        ...
        for line in file_alignment_obj:
            ...
            if num_hit_family[query] != self.top_number:
                if self.check_line(line, "family", filter_option):
                    # print "beforePprint"
            ...
            if num_hit_order[query] != self.top_number:
                if self.check_line(line, "order", filter_option):
                    # print "beforePprint"
            ...
            if num_hit_genus[query] != self.top_number:
                if self.check_line(line, "genus", filter_option):
                    # print "beforePprint"
