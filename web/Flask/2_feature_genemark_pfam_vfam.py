...
def main():
    ...
    parser.add_argument('--meta_mmp', help="the parameters file for MetaGeneMark", default = "/Users/qingpeng/Dropbox/Development/Bitbucket/jgi-genelearn/ThirdParty/genemark_suite_macosx/gmsuite/MetaGeneMark_v1.mod")
    parser.add_argument('--mmp', help="the parameters file for GeneMark", default = "/Users/qingpeng/Dropbox/Development/Bitbucket/jgi-genelearn/scripts/gm_parameters/par_11.modified")
    parser.add_argument('--pfam_db', help="the pfam database, *.hmm", default = "/Users/qingpeng/Pfam_DB/Pfam-A.hmm")
    parser.add_argument('--vfam_db', help="the vfam database, *.hmm", default = "/Users/qingpeng/Pfam_DB/vFam-B_2014.hmm")
    parser.add_argument('--IMG_db', help="the IMG virus database, *.hmm", default = "/Users/qingpeng/Pfam_DB/final_list.hmms")
